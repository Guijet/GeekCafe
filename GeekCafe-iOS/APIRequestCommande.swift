...
class APIRequestCommande{
    ...
    //
    //
    func buildJsonOrder(arrayItems:[itemOrder],card_pay:Bool,branch_id:Int,counter_id:Int,points:Int,promoCode:String = "")->Data{
    ...
    func buildJsonOrderCheckPrice(arrayItems:[itemOrder],points:Int,promoCode:String = "")->Data{
    ...
    //
    //
    func getOrderResult(arrayItems:[itemOrder],card_pay:Bool,branch_id:Int,counter_id:Int,points:Int,promoCode:String = "")->[String:Any]{
        ...
        DispatchQueue.global(qos:.background).async {
            ...
            if(promoCode == ""){
                ...
                request.httpBody = self.buildJsonOrder(arrayItems: arrayItems,card_pay: card_pay,branch_id: branch_id, counter_id: counter_id, points: points,promoCode: promoCode)
            }
    ...
    func order(arrayItems:[itemOrder],card_pay:Bool,branch_id:Int,counter_id:Int,points:Int,promoCode:String = "")->Bool{
        var worked:Bool = false
        var result:[String:Any]
        if (promoCode == ""){
           result = getOrderResult(arrayItems: arrayItems, card_pay: card_pay, branch_id: branch_id, counter_id: counter_id, points: points)
        }
        else{
            result = getOrderResult(arrayItems: arrayItems, card_pay: card_pay, branch_id: branch_id, counter_id: counter_id, points: points,promoCode: promoCode)
        }
